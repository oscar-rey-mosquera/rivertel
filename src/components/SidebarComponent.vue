...
<template>
  ...
  >
    ...
    >
      ...
      <router-link  to="/">
       <img src="/img/logorivertel.png" class="w-12 block m-auto">
      </router-link>
      ...
      >
        ...
        <ul class="md:flex-col md:min-w-full flex flex-col list-none">
         ...
         <router-link
          ...
          <li class="items-center">
            <a href="#" class="text-xs uppercase py-3 font-bold block text-blueGray-700 hover:text-blueGray-500" @click.prevent="logout">
              <i class="fas fa-table mr-2 text-sm opacity-75"></i>
              Salir
            </a>
          </li>
